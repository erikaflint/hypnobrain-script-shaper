...
// Simplified for DALL-E image storage
...
export class ObjectStorageService {
  ...
  async downloadObject(file: File, res: Response, cacheTtlSec: number = 31536000) {
    try {
      ...
      // Set appropriate headers (1 year cache for public images)
      res.set({
  ...
  async uploadDreamImage(imageBuffer: Buffer): Promise<string> {
    ...
    const fullPath = `${publicPath}/dream-thumbnails/${imageId}.png`;
    ...
    return `/public-objects/dream-thumbnails/${imageId}.png`;
  }
}
